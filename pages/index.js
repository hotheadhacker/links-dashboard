          ...
          <div className='grid place-content-center my-12'>
            <div>
                <ul className='grid grid-flow-row auto-cols-max'>
                  ...
                  <li style={{marginTop: 20}}>
                    <a href="https://opensea.io/assets/matic/0xb9e006e2f14579b2bbef21494c8cad2af71b1265/2" target='_BLANK' rel="noreferrer" className="flex rounded-sm py-2 px-10 text-lg bg-gradient-to-r from-red-500 to-yellow-500 rounded-lg hover:bg-gradient-to-r hover:from-violet-500 hover:to-fuchsia-500">🖼️ Check out this NFT </a>
                  </li>
                </ul>
            </div>
          </div>
