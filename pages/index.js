          ...
          <div className='grid place-content-center my-12'>
            <div>
                <ul className='grid grid-flow-row auto-cols-max'>
                  ...
                  <li style={{marginTop: 20}}>
                    <a href="https://calendly.com/isalman-dev/30min" target='_BLANK' rel="noreferrer" className="flex rounded-sm py-2 px-10 text-lg bg-gradient-to-r from-red-500 to-amber-500 rounded-lg hover:bg-gradient-to-r hover:from-violet-500 hover:to-fuchsia-500">💡 Have idea? Let's Discuss</a>
                  </li>
                </ul>
            </div>
          </div>
